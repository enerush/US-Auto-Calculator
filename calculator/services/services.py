...
class Calculator:
    ...
    def _calc_auc_fee(self):
        """Takes a cost of the car, returns a cost of the bank transfer fee."""
        service_fee = 79
    ...
    def _calc_ship_cost(self):
        """Takes in the name of a auction name and the name of the city, returns a cost of delivery of the auto."""
    ...
    def _calc_import_fee(self):
        """
        Takes in a type of engine, engine capacity, year of entry and the value of the car,
        returns a value of customs payments.
        """
    ...
    def _calc_year_coeff(year: int) -> int:
        """Takes in a year of entry of the car, returns a year coefficient for customs payments."""
    ...
    def _calc_engine_coeff(egn_type: str, cc: float) -> float:
        """Takes in engine type, engine capacity, and returns an engine coefficient for customs payments."""
    ...
    def _calc_car_registration(self):
        """Takes in a cost of the car, returns a cost of registering the car."""
...
class ScanData:
    """A class to represent scanning data from Copart and IAAI auctions."""
